...
public class MenuManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //    else
        //        txt.text = "Уровень " + GlobalValue.levelPlaying;
        //}
    ...
    void FinishCo()
    {
        foreach (var but in butNext)
        {
            ...
            but.SetActive(SaveManager.levelPlaying < SaveManager.levelHighest);
        }
    ...
    public void NextLevel()
    {
        ...
        SaveManager.levelPlaying++;
        LoadingUI.SetActive(true);
        //SceneManager.LoadSceneAsync(GlobalValue.levelPlaying);
