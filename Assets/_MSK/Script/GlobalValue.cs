...
public class GlobalValue : MonoBehaviour
{
    ...
    public static int firstSeasonStars
    {
        get { return PlayerPrefs.GetInt("firstSeasonStars", 0); }
        set { PlayerPrefs.SetInt("firstSeasonStars", value); }
    }
    ...
    {
        get { return PlayerPrefs.GetInt("SavedStars"); }
        set { PlayerPrefs.SetInt("SavedStars",value); }
    }
